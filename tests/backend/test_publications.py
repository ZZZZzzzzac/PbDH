...
@pytest.mark.parametrize(("template_id", "data"), [
    ...
    ("职业", {"名称": "战士", "类型": "职业", "风味描述": "久经战阵。", "领域": ["利刃", "骸骨"], "生命点": "6", "闪避值": "10", "职业物品": "武器", "希望特性": {"名称": "无畏", "原名": "Fearless", "特性描述": "直面危险。"}, "特性": [{"名称": "猛攻", "原名": "Onslaught", "特性描述": "向敌人发起猛攻。"}], "推荐初始属性": {"敏捷": "-1", "力量": "+1", "灵巧": "", "本能": "", "风度": "", "知识": ""}, "推荐初始武器": "阔剑", "推荐初始护甲": "锁甲", "背景问题": ["为何战斗？"], "关系问题": ["保护谁？"]}),
    ("子职业", {"名称": "勇者", "类型": "子职业", "主职": "战士", "等级": "基础", "施法属性": "", "特性": [{"名称": "勇往直前", "原名": "Press Forward", "特性描述": "向敌人发起冲锋。"}], "风味描述": "绝不退缩。"}),
