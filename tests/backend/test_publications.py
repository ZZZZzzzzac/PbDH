...
@pytest.mark.parametrize(("template_id", "data"), [
    ...
    ("社群", {"名称": "高岭", "类型": "社群", "简介": "来自山巅。", "性格": "坚韧", "特性": {"特性名称": "山民", "特性原文": "Highlander", "特性描述": "熟悉险地。"}}),
    ("职业", {"名称": "战士", "类型": "职业", "简介": "久经战阵。", "领域": ["利刃", "骸骨"], "生命点": "6", "闪避值": "10", "职业物品": "武器", "希望特性": {"特性名称": "无畏", "特性原文": "Fearless", "特性描述": "直面危险。"}, "特性": [{"特性名称": "猛攻", "特性原文": "Onslaught", "特性描述": "向敌人发起猛攻。"}], "推荐初始属性": {"敏捷": "-1", "力量": "+1", "灵巧": "", "本能": "", "风度": "", "知识": ""}, "推荐初始武器": "阔剑", "推荐初始护甲": "锁甲", "背景问题": ["为何战斗？"], "关系问题": ["保护谁？"]}),
    ("子职业", {"名称": "勇者", "类型": "子职业", "主职": "战士", "等级": "基础", "施法属性": "", "特性": [{"特性名称": "勇往直前", "特性原文": "Press Forward", "特性描述": "向敌人发起冲锋。"}], "简介": "绝不退缩。"}),
    ("物品", {"名称": "治疗药水", "类型": "消耗品", "掷骰": "d4", "特性描述": "恢复生命。", "简介": "温热的红色药剂。"}),
    ("领域卡", {"名称": "旋风斩", "类型": "领域卡", "领域": "利刃", "等级": "1", "属性": "能力", "回想": "1", "特性描述": "攻击附近敌人。", "简介": "剑锋卷起狂风。"}),
    ("自由", {"名称": "复仇誓言", "类型": "专属", "简介": "不可违背的誓言。", "内容": [{"名称": "效果", "描述": "造成伤害时，伤害+2。"}]}),
])
