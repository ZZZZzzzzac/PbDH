...
await writeFile(path.join(outputRoot, "runtime-libraries", "survivor-styles.json"), "[]\n", "utf8");
...
manifest.resourceLibraries = [{
  ID: "survivor-styles",
  名称: "求生者风格",
  路径: "runtime-libraries/survivor-styles.json",
}];
...
const runtimeFiles = [
  ...
  "manifest.json",
  "runtime-libraries/survivor-styles.json",
].sort();
await writeFile(
