...
整理日期：2026-09-11。**v0.1.19 已发布并部署到正式站点**，回执见下文。历史可从 Git 查询，发布与恢复操作见 [部署说明](../deploy/README.md)。
...
- 合并后 `npm run verify` 全部通过：142 个 TypeScript 测试文件、1,270 个测试与 170 个 Python 测试通过。
- 发布提交 `e29a78138e5094ffbcd1d07f86f5e553836d91ed`，标签 `v0.1.19`；[Release](https://github.com/ZZZZzzzzac/PbDH/actions/runs/34617890749) 与 [Deploy Release](https://github.com/ZZZZzzzzac/PbDH/actions/runs/34618211091) 均成功。
- 独立检查正式首页版本为 `0.1.19`，API health 返回 `status: ok`；真实线上 Creator 页面正常加载 980 个资源。原资源包仍保留，未执行线上删除验收。
