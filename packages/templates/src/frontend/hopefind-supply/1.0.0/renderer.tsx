...
import { supplyFieldEntries as freeFieldEntries, hopefindSupplyTemplate as freeTemplate, type HopefindSupplyData as FreeData } from "../../../core/hopefind-supply/1.0.0/capability.ts";
...
.hopefind-supply-card{--ink:#1d1713;--bone:#eee4d0;--oxblood:#641f1d;box-sizing:border-box;width:100%;height:100%;overflow:hidden;display:flex;flex-direction:column;background:var(--bone);color:var(--ink);border:1px solid #21150f;font-family:"Noto Sans SC",sans-serif}.hopefind-supply-card *{box-sizing:border-box}.hopefind-supply-card.is-fluid{height:auto;min-height:100%;overflow:visible}.free-header{padding:10px 14px;background:#251a14;color:#fff4df;border-bottom:3px solid #b88a57}.free-type{margin:0 0 2%;color:#f4dfbc;font:650 clamp(9px,3cqw,13px)/1.2 "Noto Sans SC",sans-serif;letter-spacing:.1em}.free-title{margin:0;overflow:hidden;font:800 var(--free-title-font-size,clamp(20px,8cqw,36px))/1.2 "Noto Sans SC",sans-serif;white-space:nowrap}.free-content{padding:6% 7%;display:flex;min-height:0;flex:1;flex-direction:column;gap:4%;overflow:auto}.free-block{padding:6px;background:#f7ebd6;border:1px solid #d4b78d;border-radius:4px}.free-block h2{display:flex;align-items:center;gap:8px;margin:0 0 2%;color:var(--oxblood);font:800 clamp(11px,3.6cqw,16px)/1.2 "Noto Sans SC",sans-serif}.free-block h2::after{content:"";flex:1;height:1px;background:#b88a57}.free-block p{margin:0;white-space:pre-wrap;font:450 clamp(10px,3.4cqw,15px)/1.42 "Noto Sans SC",sans-serif}.free-art{height:170px;flex:none;background:#251a14;overflow:hidden}.free-art img{width:100%;height:100%;display:block;object-fit:cover}.free-image-missing{height:100%;display:grid;place-items:center;color:#f4dfbc;font:650 11px/1.3 "Noto Sans SC",sans-serif}.hopefind-supply-card.is-image .free-header,.hopefind-supply-card.is-image .free-content{display:none}.hopefind-supply-card.is-image .free-art{height:100%}.hopefind-supply-card.is-image.is-fluid .free-art,.hopefind-supply-card.is-image.is-fluid .free-art img{height:auto}.hopefind-supply-card.is-text .free-art{display:none}
.free-block [data-restricted-markdown]{font:450 clamp(10px,3.4cqw,15px)/1.42 "Noto Sans SC",sans-serif}
.free-original{margin:2% 0 0;color:#d8ba91;font:650 clamp(10px,3.25cqw,13px)/1.25 "Noto Sans SC",sans-serif}.free-content{overflow:hidden}.hopefind-supply-card.is-fluid .free-content{flex:none;overflow:visible}.free-block{flex:none}.free-block h2{flex-wrap:wrap;align-items:baseline;font-size:clamp(15px,5cqw,21px)}.free-block h2 small{color:#725747;font:650 clamp(10px,3.25cqw,13px)/1.25 "Noto Sans SC",sans-serif}.free-block p,.free-block [data-restricted-markdown]{font-size:var(--free-content-font-size,15px)}.hopefind-supply-card>.pbdh-card-footer{color:#725747;background:var(--bone);border-top:1px solid #d4b78d}.free-art{position:relative}.free-art>.pbdh-card-footer.is-overlay{position:absolute;z-index:2;inset:auto 0 0;color:#fff4df;background:linear-gradient(180deg,#1d131000,#1d1310dc);text-shadow:0 1px 2px #0e0907}.hopefind-supply-card.is-image>.pbdh-card-footer{display:none}
.hopefind-supply-card{position:relative}.free-title-row{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:end;gap:6%}.free-title-row .free-title{min-width:0}.free-type{margin:0;color:#f4dfbc;font:650 clamp(10px,3.5cqw,15px)/1.2 "Noto Sans SC",sans-serif;text-align:right}.hopefind-supply-card.is-split .free-header{position:absolute;z-index:2;inset:0 0 auto;height:170px;display:flex;flex-direction:column;justify-content:flex-end;background:linear-gradient(180deg,#1d131000 10%,#1d131061 42%,#1d1310e8 100%);text-shadow:0 1px 2px #0e0907}.hopefind-supply-card.is-split .free-art{order:-1}
.hopefind-supply-card-frame{position:relative;width:63px;height:88px;overflow:hidden}.hopefind-supply-card-frame.is-fluid{overflow:visible}.hopefind-supply-card{position:absolute;inset:0 auto auto 0;width:360px;height:502.857px;transform:scale(.175);transform-origin:top left}.hopefind-supply-card.is-fluid{height:auto}
.hopefind-supply-card.is-split{height:auto;min-height:0;overflow:visible}.hopefind-supply-card.is-split .free-art{position:relative;height:auto;overflow:visible}.hopefind-supply-card.is-split .free-art img{width:100%;height:auto;object-fit:contain}.hopefind-supply-card.is-split.has-portrait .free-header{inset:auto 0 0;height:auto;min-height:74px;background:linear-gradient(180deg,#1d131000 0%,#1d1310b8 48%,#1d1310f5 100%)}.hopefind-supply-card.is-split:not(.has-portrait) .free-header{position:relative;height:auto;background:#251a14}.hopefind-supply-card.is-split:not(.has-portrait) .free-art{min-height:74px}
.hopefind-supply-card.is-split.has-fixed-base{height:var(--split-fixed-native-height)}
.free-summary[data-restricted-markdown]{margin:2% 0 0;color:#dcb299;font:italic 500 clamp(10px,3.5cqw,14px)/1.4 "Noto Sans SC",sans-serif;overflow-wrap:anywhere}.free-fields{display:flex;flex-wrap:wrap;gap:5px;margin:0}.free-field-tag{display:inline-flex;max-width:100%;align-items:baseline;gap:3px;padding:3px 7px;border:1px solid #c9a876;border-radius:999px;background:#ead9bc;color:var(--ink);font:600 clamp(10px,3.1cqw,13px)/1.3 "Noto Sans SC",sans-serif;overflow-wrap:anywhere}.free-field-tag b{color:var(--oxblood);font-weight:800}.free-field-tag b::after{content:":"}.free-field-tag.is-label b::after{content:none}
`;
...
function FreeCard({ data, presentation, portrait, attribution }: {
  ...
  return <div
    className={`hopefind-supply-card-frame${fixedSurface ? "" : " is-fluid"}`}
    style={{ height: `${fixedSurface ? 88 : nativeHeight * freeScale}px`, "--split-fixed-native-height": `${nativeHeight}px` } as CSSProperties}
  ><article ref={cardRef} className={["hopefind-supply-card", `is-${presentation.mode}`, fixedSurface ? "" : "is-fluid", splitFixed ? "has-fixed-base" : "", portrait ? "has-portrait" : ""].filter(Boolean).join(" ")} data-renderer-revision="hopefind-supply-card-r5">
    ...
    <div className="free-content" ref={contentRef}>
      {fields.length ? <div className="free-fields">{fields.map(([name, value]) => {
        const labelOnly = !value.trim();
        return <span className={`free-field-tag${labelOnly ? " is-label" : ""}`} key={name}><b>{name}</b>{labelOnly ? null : <span>{value}</span>}</span>;
      })}</div> : null}
...
export const hopefindSupplyRendererRevision: RendererRevisionCapability<FreeData, FreeRuntimeState, ReactNode> = {
  revision: "hopefind-supply-card-r1",
  templateId: "寻望物资",
