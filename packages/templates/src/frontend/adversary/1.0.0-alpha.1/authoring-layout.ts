  ...
  sections: [
    ...
    },
    {
      ...
      fields: [
        ...
        { path: "压力点", label: "压力点", control: "text" },
        { path: "攻击命中", label: "攻击命中", control: "text" },
        { path: "攻击武器", label: "攻击武器", control: "text" },
        { path: "攻击范围", label: "攻击范围", control: "text" },
        { path: "攻击伤害", label: "攻击伤害", control: "text" },
        { path: "攻击属性", label: "攻击属性", control: "text" },
      ],
    },
    {
      id: "features",
      ...
      repeats: [
        {
          ...
          itemFields: [
            ...
            { path: "类型", label: "类型", control: "text" },
            { path: "特性描述", label: "特性描述", control: "textarea" },
          ],
        },
      ],
    },
