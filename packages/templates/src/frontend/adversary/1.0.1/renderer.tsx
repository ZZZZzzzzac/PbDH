...
.enemy-card.is-split.has-portrait .enemy-heading { inset: auto 0 0; height: 74px; background: linear-gradient(180deg, #1d131000 0%, #1d1310b8 48%, #1d1310f5 100%); }
.enemy-card.is-split .enemy-heading h1 { top: 10px; }
.enemy-card.is-split .enemy-original-title,
.enemy-card.is-split .enemy-summary { top: 42px; }
.enemy-card.is-split .enemy-heading.has-original-title .enemy-summary { top: 57px; }
.enemy-card.is-split .enemy-kicker { top: auto; bottom: 17px; }
