...
export const weaponAuthoringLayout: AuthoringLayout = {
  ...
  sections: [
    { id: "identity", label: "武器", columns: 2, fields: [
      { path: "名称", label: "名称", control: "text" }, { path: "类型", label: "类型", control: "text" },
      { path: "位阶", label: "位阶", control: "text" }, { path: "风味描述", label: "风味描述", control: "textarea", span: 2 },
    ] },
    { id: "combat", label: "属性", columns: 3, fields: [
    ...
    { id: "feature", label: "游戏效果", columns: 2, fields: [{ path: "描述", label: "游戏效果", control: "textarea", span: 2 }] },
  ],
};
