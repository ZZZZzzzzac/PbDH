...
export const weaponAuthoringLayoutV2: AuthoringLayout = {
  templateId: "武器",
  ...
  sections: [
    ...
    },
    {
      ...
      fields: [
        ...
        { path: "距离", label: "距离", control: "text" },
        { path: "伤害", label: "伤害", control: "text" },
        { path: "伤害类型", label: "伤害类型", control: "text" },
    ...
    },
    {
      id: "feature",
      label: "游戏效果",
      fields: [{ path: "描述", label: "游戏效果", control: "textarea" }],
    },
  ],
};
