...
import { freeFieldEntries, freeTemplate, type FreeData } from "../../../core/free/1.0.2/capability.ts";
...
function FreeCard({ data, presentation, portrait, attribution }: {
  ...
  ><article ref={cardRef} className={["free-card", `is-${presentation.mode}`, fixedSurface ? "" : "is-fluid", splitFixed ? "has-fixed-base" : "", portrait ? "has-portrait" : ""].filter(Boolean).join(" ")} data-renderer-revision="free-card-r5">
