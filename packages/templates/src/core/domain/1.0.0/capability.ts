...
export type DomainData = {
  名称: string; 原文?: string; 类型: string; 领域: string; 等级: string; 属性: string; 回想: string; 描述: string; 风味描述: string;
};

const defaultData: DomainData = { 名称: "", 原文: "", 类型: "领域卡", 领域: "", 等级: "", 属性: "", 回想: "", 描述: "", 风味描述: "" };
