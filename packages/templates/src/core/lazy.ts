import { retryTemplateImport } from "./retry-import.ts";
...
export const templateCoreLoaders: readonly TemplateCoreLoaderEntry[] = [
  ...
  { id: "敌人", version: "1.0.2", fromVersions: ["1.0.1"], load: () => retryTemplateImport("./adversary/1.0.2/capability.ts", () => import("./adversary/1.0.2/capability.ts")).then((module) => module.adversaryTemplate) },
  ...
  { id: "种族", version: "1.1.0", fromVersions: ["1.0.1"], load: () => retryTemplateImport("./ancestry/1.1.0/capability.ts", () => import("./ancestry/1.1.0/capability.ts")).then((module) => module.ancestryTemplate) },
  { id: "护甲", version: "1.0.0", fromVersions: [], load: () => retryTemplateImport("./armor/1.0.0/capability.ts", () => import("./armor/1.0.0/capability.ts")).then((module) => module.armorTemplate) },
  { id: "护甲", version: "1.0.1", fromVersions: ["1.0.0"], load: () => retryTemplateImport("./armor/1.0.1/capability.ts", () => import("./armor/1.0.1/capability.ts")).then((module) => module.armorTemplate) },
  { id: "护甲", version: "1.1.0", fromVersions: ["1.0.1"], load: () => retryTemplateImport("./armor/1.1.0/capability.ts", () => import("./armor/1.1.0/capability.ts")).then((module) => module.armorTemplate) },
  { id: "社群", version: "1.0.0", fromVersions: [], load: () => retryTemplateImport("./community/1.0.0/capability.ts", () => import("./community/1.0.0/capability.ts")).then((module) => module.communityTemplate) },
  { id: "社群", version: "1.0.1", fromVersions: ["1.0.0"], load: () => retryTemplateImport("./community/1.0.1/capability.ts", () => import("./community/1.0.1/capability.ts")).then((module) => module.communityTemplate) },
  { id: "社群", version: "1.1.0", fromVersions: ["1.0.1"], load: () => retryTemplateImport("./community/1.1.0/capability.ts", () => import("./community/1.1.0/capability.ts")).then((module) => module.communityTemplate) },
  { id: "领域卡", version: "1.0.0", fromVersions: [], load: () => retryTemplateImport("./domain/1.0.0/capability.ts", () => import("./domain/1.0.0/capability.ts")).then((module) => module.domainTemplate) },
  { id: "领域卡", version: "1.0.1", fromVersions: ["1.0.0"], load: () => retryTemplateImport("./domain/1.0.1/capability.ts", () => import("./domain/1.0.1/capability.ts")).then((module) => module.domainTemplate) },
  { id: "领域卡", version: "1.1.0", fromVersions: ["1.0.1"], load: () => retryTemplateImport("./domain/1.1.0/capability.ts", () => import("./domain/1.1.0/capability.ts")).then((module) => module.domainTemplate) },
  { id: "环境", version: "1.0.0", fromVersions: [], load: () => retryTemplateImport("./environment/1.0.0/capability.ts", () => import("./environment/1.0.0/capability.ts")).then((module) => module.environmentTemplate) },
  ...
  { id: "自由", version: "1.0.2", fromVersions: ["1.0.1"], load: () => retryTemplateImport("./free/1.0.2/capability.ts", () => import("./free/1.0.2/capability.ts")).then((module) => module.freeTemplate) },
  { id: "自由", version: "1.1.0", fromVersions: ["1.0.2"], load: () => retryTemplateImport("./free/1.1.0/capability.ts", () => import("./free/1.1.0/capability.ts")).then((module) => module.freeTemplate) },
  ...
  { id: "子职业", version: "1.0.0", fromVersions: [], load: () => retryTemplateImport("./subclass/1.0.0/capability.ts", () => import("./subclass/1.0.0/capability.ts")).then((module) => module.subclassTemplate) },
  { id: "子职业", version: "1.0.1", fromVersions: ["1.0.0"], load: () => retryTemplateImport("./subclass/1.0.1/capability.ts", () => import("./subclass/1.0.1/capability.ts")).then((module) => module.subclassTemplate) },
  { id: "子职业", version: "1.1.0", fromVersions: ["1.0.1"], load: () => retryTemplateImport("./subclass/1.1.0/capability.ts", () => import("./subclass/1.1.0/capability.ts")).then((module) => module.subclassTemplate) },
  { id: "武器", version: "1.0.0", fromVersions: [], load: () => retryTemplateImport("./weapon/1.0.0/capability.ts", () => import("./weapon/1.0.0/capability.ts")).then((module) => module.weaponTemplate) },
  { id: "武器", version: "1.0.1", fromVersions: ["1.0.0"], load: () => retryTemplateImport("./weapon/1.0.1/capability.ts", () => import("./weapon/1.0.1/capability.ts")).then((module) => module.weaponTemplate) },
  { id: "武器", version: "1.1.0", fromVersions: ["1.0.1"], load: () => retryTemplateImport("./weapon/1.1.0/capability.ts", () => import("./weapon/1.1.0/capability.ts")).then((module) => module.weaponTemplate) },
];
